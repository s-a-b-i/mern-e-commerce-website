...
const EditProduct = ({ product, onClose, onEdit }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axiosInstance.put(`${ApiCollection.editProduct.url}/${product._id}`, productData);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold p-6 text-center text-green-600 border-b bg-gray-50 rounded-t-3xl">Edit Product</h2>
