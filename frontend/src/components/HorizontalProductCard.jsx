        ...
        >
          {products.map((product) => (
            <Link to={`/product/${product._id}`} key={product._id}>
              <motion.div 
                className="flex-shrink-0 w-[280px] sm:w-[350px] h-[180px] sm:h-[200px] bg-white rounded-lg shadow-lg overflow-hidden border-2 border-mint-200"
                style={{ 
              ...
              >
                <div className="flex h-full">
                  <div className="w-1/2 bg-mint-200 overflow-hidden">
                  ...
                  <div className="w-1/2 p-2 sm:p-4 flex flex-col justify-between bg-white">
                    <div>
                      <h3 className="text-sm sm:text-xl font-semibold text-gray-800 mb-1 sm:mb-2 font-sans truncate">{product.name}</h3>
                      <p className="text-xs sm:text-sm text-gray-600"><span className="font-bold">Price:</span> ₹{product.price}</p>
                      <p className="text-xs sm:text-sm text-mint-500"><span className="font-bold">Sale:</span> ₹{product.sellingPrice}</p>
